function TASH_cluster_half(side,D)
...
for isub = 1:length(subjectsID)
 ...
 %%%%cutting point        
  ...
  for this_cluster=1:ic
     ...
     fname = fullfile(D_load,[side, '_masked_thr0', th_string(3:end), suff1, '_expanded', expanded, suff2, '_erosion_dilatation_', erosion_dilatation_order, '_half_g', g_num, '.curv']);
     disp(['saving ', fname]);
     ...
     fname = fullfile(D_load,[side, '_masked_thr0', th_string(3:end), suff1, '_expanded', expanded, suff2, '_erosion_dilatation_', erosion_dilatation_order, '_half_g', g_num, '.w']);
     disp(['saving ', fname]);
     ...
     fname = fullfile(D_load,[side, '_masked_thr0', th_string(3:end), suff1, '_expanded', expanded, suff2, '_erosion_dilatation_', erosion_dilatation_order, '_half_g', g_num, '.label']);
     fid = fopen(fname,'w');
     fprintf(fid, '# \n %d \n', NumTotalVertex);
     teste=0;
     ...
     fname = fullfile(D_load,[side, '_masked_thr0', th_string(3:end), suff1, '_expanded', expanded, suff2, '_erosion_dilatation_', erosion_dilatation_order, '_half_g_all.curv']);
     disp(['saving ', fname]);
     write_curv(fname, curv,fnum);
     ...
     fname = fullfile(D_load,[side, '_masked_thr0', th_string(3:end), suff1, '_expanded', expanded, suff2, '_erosion_dilatation_', erosion_dilatation_order, '_half_g_all.w']);
     disp(['saving ', fname]);
     write_wfile(fname, Curv_w, vcurv_index); 
     ...
     NumTotalVertex=length(vcurv_index);
     fname = fullfile(D_load,[side, '_masked_thr0', th_string(3:end), suff1, '_expanded', expanded, suff2, '_erosion_dilatation_', erosion_dilatation_order, '_half_g_all.label']);
     fid = fopen(fname,'w');
     fprintf(fid, '# \n %d \n', NumTotalVertex);
     teste=0;
     for i=1:NumTotalVertex
